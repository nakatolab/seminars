...
　本セミナーはAMED-PRIME「頑健なデータ駆動形エピゲノム解析を実現する情報解析システムの構築」のサポートを得て実施した「マルチNGSオミクス解析研究会」に端を発しますが、現在は中戸研の公開行事として継続しています。本セミナーは原則として対面とZoomのハイブリッドで開催する公開セミナーであり、どなたでも参加できます。<br> 
